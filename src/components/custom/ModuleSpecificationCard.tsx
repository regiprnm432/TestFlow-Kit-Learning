  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md h-screen">
      <div className="max-h-[80vh] overflow-y-auto">
        ...
        <h3 className="text-lg font-semibold mb-2 module-description">
          Deskripsi Modul
        </h3>
        <p className="mb-4 module-description">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
          pretium, felis eget faucibus molestie, arcu ligula luctus felis, in
          viverra eros ex id enim. Integer bibendum tellus eget risus pharetra
          eleifend.
        </p>
        <h3 className="text-lg font-semibold mb-2 module-parameter">
          Parameter
        </h3>
        ...
        <h3 className="text-lg font-semibold mb-2 module-title">
          Source Code (Java)
        </h3>
